...
function cssmin() {
  ...
  .pipe(cleanCSS())
  .pipe(dest('dist/source-files/azurio-css-min-files/'))
}
...
function cssexp() {
  ...
  .pipe(dest('dist/source-files/azurio-css-files/'))
}
...
function libsexp() {
  ...
  .pipe(concat('libs.js'))
  .pipe(dest('dist/source-files/azurio-js-files/'))
}
